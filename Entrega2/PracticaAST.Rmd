...
Como se ha comentado anteriormente, solo se va a comprobar la validación de 2 de los 4 modelos propuestos. En caso que esta no se cumpla, se seleccionarán otros modelos y se repetirá el proceso que se verá a continuación. Pero, *¿Qué necesita un modelo para ser validado?*
...
**Square Root of Absolute residuals:** La línea roja es nada constante, por lo tanto la varianza también lo es.
...
En los gráficos ACF y PACF de los residuos al cuadrado tampoco se observa autocorrelación.
